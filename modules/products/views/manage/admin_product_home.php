...
if (count($products)){
	...
	echo "<th>".$this->lang->line('kago_productid')."</th>\n<th>".$this->lang->line('kago_name').
            ...
            $this->lang->line('kago_status')."</th><th>".$this->lang->line('kago_featured')."</th><th>".$this->lang->line('kago_price').
	...
	foreach ($products as $key => $list){
       ...
       // echo "<td align='center'>".form_checkbox('p_id[]',$list['id'],FALSE)."</td>";
		...
		echo anchor("kaimonokago/admin/changeStatus/$module/".$list['id']."/manage/".$category_id,$this->bep_assets->icon($active_icon), array('class' => $list['status']));
		echo "</td>\n";
