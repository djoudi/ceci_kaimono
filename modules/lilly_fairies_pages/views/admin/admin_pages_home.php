...
<div class="buttons">
	<a href="<?php print  site_url('lilly_fairies_pages/admin/create')?>">
...
if (count($pages)){
	...
	foreach ($pages as $key => $list){
		...
		echo "<td>";
        echo anchor('lilly_fairies_pages/admin/edit/'.$list['id']."/".$list['path'],$list['name']);
        echo "</td>\n";
		echo "<td>";
        if(!$list['langname']){
		...
		*/
        ...
        echo "</td>\n";
		echo "<td align='center'>";
		echo anchor($module.'/admin/edit/'.$list['id']."/".$list['path'],$this->bep_assets->icon('pencil'));
		...
		echo "<td align='center'>".$list['id']."</td>\n";
		echo "<td>";
        echo anchor($module.'/admin/edit/'.$list['id']."/".$list['path'],$list['name']);
        echo "</td>\n";
		echo "<td>";
        if(!$list['langname']){
   		//if (!preg_match("/\.html$/",$list['path'])){
